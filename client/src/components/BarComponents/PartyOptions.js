...
import { changePartyOptions, toggleModal } from "../../actions/userActions";
        ...
        <Collection id="party-options-collection" className="col ">
          ...
          >
            ...
            <p id="party">
              ...
              the bottle". Other users will NOT be able to send you messages or
              purchase drinks for you.
            </p>
          </CollectionItem>
          <CollectionItem
            id="message"
            ...
            onClick={toggleSelect}
          >
            <h3 id="message" className={`${selected.party ? "grey-text" : ""}`}>
              <Icon id="message">message</Icon>Drunk Dial
            </h3>
            <p id="message" className={`${selected.party ? "grey-text" : ""}`}>
              Loose Lips, Sink Ships! Hopefully, that won't be the case. With
              this option selected other users will be able to send you a short
              message. Who knows what could happen?
            </p>
          </CollectionItem>
          <CollectionItem
            id="buyDrinks"
...
export default connect(mapStateToProps, { changePartyOptions, toggleModal })(
  PartyOptions
);
